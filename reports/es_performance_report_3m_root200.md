...
- Generated: 2026-04-01T17:04:09Z
...
- Date range: 2026-01-01T17:03:38Z .. 2026-04-01T17:03:38Z
- Range: 3m
- Root size: 200
- Sub multiplier: 2.0
- Sub size: 400
...
| --- | --- |
| Runs | 250 |
| Root avg wall (ms) | 60.96 |
| Root min/max wall (ms) | 49.71 / 244.86 |
| Sub avg wall (ms) | 60.85 |
| Sub min/max wall (ms) | 46.80 / 154.13 |
| Total avg wall (ms) | 123.99 |
| Total min/max (ms) | 98.95 / 362.95 |
| Root avg ES took (ms) | 8.34 |
| Sub avg ES took (ms) | 8.19 |
    ...
    "bool": {
      "filter": [
        ...
        },
        {
          "range": {
            "transaction_date": {
              "gte": "2026-01-01T17:03:38Z",
              "lte": "2026-04-01T17:03:38Z"
            }
          }
        }
      ],
